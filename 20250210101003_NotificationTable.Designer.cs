...
namespace Library.Migrations
{
    ...
    [Migration("20250210101003_NotificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.AddToCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Models.Notification", b =>
                {
                    b.HasOne("Library.Models.Borrow", "BorrowTable")
                        .WithMany()
                        .HasForeignKey("BorrowTableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BorrowTable");
                });
